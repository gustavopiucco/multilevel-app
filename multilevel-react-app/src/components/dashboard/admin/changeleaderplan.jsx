...
class ChangeLeaderPlan extends React.Component {
    constructor(props) {
        super(props)
    ...
    async doActivateLeader(e) {
        ...
        const response = await ApiService.put('/admin/changeleaderplan', { leaderUsername: this.state.leaderUsername, leaderPlanId: this.state.leaderPlanId })
    ...
    render() {
        return (
            <Card>
                <div className="p-3">
                    <CardTitle><i className="mdi mdi-account-settings-variant mr-2"></i>Admin - Upgrade Leader</CardTitle>
                </div>
...
export default ChangeLeaderPlan;